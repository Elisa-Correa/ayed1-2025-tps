def solicitar_positivos() -> list:
    """
       Solicita al usuario que ingrese por teclado 3 números positivos,
...
def buscar_mayor_estricto(a: int, b: int, c: int) -> int:
    """
    Busca el número mayor, de 3 números entero recibidos, los almacena en una lista y luego la recorre.

    Pre: Recibe 3 números enteros

    Post: Retorna el número mayor, en caso de no ser el mayor extricto retorna -1.
    """
